...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Eif(window.pendo\u0026\u0026\"function\"===typeof window.pendo.initialize){var visitorDetails={id:",["escape",["macro",19],8,16],",email:",["escape",["macro",12],8,16],",cbPro:",["escape",["macro",14],8,16],",cbProTrial:(",["escape",["macro",15],8,16],"||{}).protrial||!1,cbProSubStartDate:",["escape",["macro",18],8,16],",loggedIn:",["escape",["macro",13],8,16],",contributor:(",["escape",["macro",15],8,16],"||{}).contributor||!1};Object.keys(",["escape",["macro",15],8,16],"||{}).forEach(function(a){visitorDetails[a]=",["escape",["macro",15],8,16],"[a]||!1});Object.keys(",["escape",["macro",20],8,16],"||{}).forEach(function(a){var b=\n",["escape",["macro",20],8,16],"[a];\"object\"!==typeof b\u0026\u0026(visitorDetails[a]=",["escape",["macro",20],8,16],"[a])});pendo.initialize({ignoreHashRouting:!0,visitor:visitorDetails})};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":59
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar refurl=(",["escape",["macro",21],8,16],"||\"\").split(\"\/\");2\u003Crefurl.length\u0026\u0026\"about.crunchbase.com\"==refurl[2]\u0026\u0026(document.cookie=\"about-refer\\x3dtrue\");\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":60
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Eif(window.adaEmbed)try{",["escape",["macro",14],8,16],"\u0026\u0026window.adaEmbed.setMetaFields({page_url:",["escape",["macro",24],8,16],"})}catch(a){};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":72
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.helpScriptReady=!0;\ntry{",["escape",["macro",14],8,16],"||!",["escape",["macro",27],8,16],"?(window.adaEmbed.start(window.adaSettings),window.adaEmbed.setMetaFields({email:",["escape",["macro",12],8,16],",first_name:",["escape",["macro",22],8,16],",last_name:",["escape",["macro",23],8,16],"}),",["escape",["macro",27],8,16],"\u0026\u0026setTimeout(function(){window.adaEmbed\u0026\u0026window.adaEmbed.toggle()},300)):(zE(\"webWidget\",\"updateSettings\",{webWidget:{helpCenter:{suppress:!1},contactForm:{suppress:!1}}}),",["escape",["macro",27],8,16],"\u0026\u0026setTimeout(function(){zE(\"webWidget\",\"open\")},300))}catch(a){};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":75
      ...
      "function":"__html",
      "once_per_load":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003E",["escape",["macro",12],8,16],"\u0026\u0026FS.identify(",["escape",["macro",12],8,16],",{displayName:",["escape",["macro",12],8,16],",email:",["escape",["macro",12],8,16],"});FS.setUserVars({cbpro_bool:",["escape",["macro",14],8,16],",loggedin_bool:",["escape",["macro",13],8,16],"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":34
...
var de,ee=function(){};(function(){function a(k,l){k=k||"";l=l||{};for(var m in b)b.hasOwnProperty(m)&&(l.If&&(l["fix_"+m]=!0),l.ne=l.ne||l["fix_"+m]);var n={comment:/^\x3c!--/,endTag:/^<\//,atomicTag:/^<\s*(script|style|noscript|iframe|textarea)[\s\/>]/i,startTag:/^</,chars:/^[^<]/},p={comment:function(){var q=k.indexOf("--\x3e");if(0<=q)return{content:k.substr(4,q),length:q+3}},endTag:function(){var q=k.match(d);if(q)return{tagName:q[1],length:q[0].length}},atomicTag:function(){var q=p.startTag();
if(q){var u=k.slice(q.length);if(u.match(new RegExp("</\\s*"+q.tagName+"\\s*>","i"))){var v=u.match(new RegExp("([\\s\\S]*?)</\\s*"+q.tagName+"\\s*>","i"));if(v)return{tagName:q.tagName,R:q.R,content:v[1],length:v[0].length+q.length}}}},startTag:function(){var q=k.match(c);if(q){var u={};q[2].replace(e,function(v,w,y,x,z){var C=y||x||z||f.test(w)&&w||null,A=document.createElement("div");A.innerHTML=C;u[w]=A.textContent||A.innerText||C});return{tagName:q[1],R:u,rb:!!q[3],length:q[0].length}}},chars:function(){var q=
k.indexOf("<");return{length:0<=q?q:k.length}}},t=function(){for(var q in n)if(n[q].test(k)){var u=p[q]();return u?(u.type=u.type||q,u.text=k.substr(0,u.length),k=k.slice(u.length),u):null}};l.ne&&function(){var q=/^(AREA|BASE|BASEFONT|BR|COL|FRAME|HR|IMG|INPUT|ISINDEX|LINK|META|PARAM|EMBED)$/i,u=/^(COLGROUP|DD|DT|LI|OPTIONS|P|TD|TFOOT|TH|THEAD|TR)$/i,v=[];v.we=function(){return this[this.length-1]};v.Tc=function(A){var F=this.we();return F&&F.tagName&&F.tagName.toUpperCase()===A.toUpperCase()};v.Xf=
function(A){for(var F=0,J;J=this[F];F++)if(J.tagName===A)return!0;return!1};var w=function(A){A&&"startTag"===A.type&&(A.rb=q.test(A.tagName)||A.rb);return A},y=t,x=function(){k="</"+v.pop().tagName+">"+k},z={startTag:function(A){var F=A.tagName;"TR"===F.toUpperCase()&&v.Tc("TABLE")?(k="<TBODY>"+k,C()):l.hi&&u.test(F)&&v.Xf(F)?v.Tc(F)?x():(k="</"+A.tagName+">"+k,C()):A.rb||v.push(A)},endTag:function(A){v.we()?l.kg&&!v.Tc(A.tagName)?x():v.pop():l.kg&&(y(),C())}},C=function(){var A=k,F=w(y());k=A;if(F&&
z[F.type])z[F.type](F)};t=function(){C();return w(y())}}();return{append:function(q){k+=q},sh:t,ni:function(q){for(var u;(u=t())&&(!q[u.type]||!1!==q[u.type](u)););},clear:function(){var q=k;k="";return q},oi:function(){return k},stack:[]}}var b=function(){var k={},l=this.document.createElement("div");l.innerHTML="<P><I></P></I>";k.si="<P><I></P></I>"!==l.innerHTML;l.innerHTML="<P><i><P></P></i></P>";k.ri=2===l.childNodes.length;return k}(),c=/^<([\-A-Za-z0-9_]+)((?:\s+[\w\-]+(?:\s*=?\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
...
" "+p+'="'+(t?t.replace(/(^|[^\\])"/g,'$1\\"'):"")+'"'}return n+(m.rb?"/>":">")},chars:function(m){return m.text}};return l[k.type](k)};a.i=function(k){var l={},m;for(m in k){var n=k[m];l[m]=n&&n.replace(/(^|[^\\])"/g,'$1\\"')}return l};for(var h in b)a.a=a.a||!b[h]&&h;de=a})();(function(){function a(){}function b(p){return void 0!==p&&null!==p}function c(p,t,q){var u,v=p&&p.length||0;for(u=0;u<v;u++)t.call(q,p[u],u)}function d(p,t,q){for(var u in p)p.hasOwnProperty(u)&&t.call(q,u,p[u])}function e(p,
t){d(t,function(q,u){p[q]=u});return p}function f(p,t){p=p||{};d(t,function(q,u){b(p[q])||(p[q]=u)});return p}function h(p){try{return m.call(p)}catch(q){var t=[];c(p,function(u){t.push(u)});return t}}var k={yf:a,zf:a,Af:a,Bf:a,Kf:a,Lf:function(p){return p},done:a,error:function(p){throw p;},vh:!1},l=this;if(!l.postscribe){var m=Array.prototype.slice,n=function(){function p(q,u,v){var w="data-ps-"+u;if(2===arguments.length){var y=q.getAttribute(w);return b(y)?String(y):y}b(v)&&""!==v?q.setAttribute(w,
v):q.removeAttribute(w)}function t(q,u){var v=q.ownerDocument;e(this,{root:q,options:u,sb:v.defaultView||v.parentWindow,Ka:v,ac:de("",{If:!0}),Fc:[q],cd:"",dd:v.createElement(q.nodeName),ob:[],Ba:[]});p(this.dd,"proxyof",0)}t.prototype.write=function(){[].push.apply(this.Ba,arguments);for(var q;!this.Lb&&this.Ba.length;)q=this.Ba.shift(),"function"===typeof q?this.Qf(q):this.qd(q)};t.prototype.Qf=function(q){var u={type:"function",value:q.name||q.toString()};this.$c(u);q.call(this.sb,this.Ka);this.Ae(u)};
t.prototype.qd=function(q){this.ac.append(q);for(var u,v=[],w,y;(u=this.ac.sh())&&!(w=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("script"):!1)&&!(y=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("style"):!1);)v.push(u);this.Th(v);w&&this.ug(u);y&&this.vg(u)};t.prototype.Th=function(q){var u=this.Nf(q);u.ce&&(u.Pc=this.cd+u.ce,this.cd+=u.nh,this.dd.innerHTML=u.Pc,this.Qh())};t.prototype.Nf=function(q){var u=this.Fc.length,v=[],w=[],y=[];c(q,function(x){v.push(x.text);if(x.R){if(!/^noscript$/i.test(x.tagName)){var z=
u++;w.push(x.text.replace(/(\/?>)/," data-ps-id="+z+" $1"));"ps-script"!==x.R.id&&"ps-style"!==x.R.id&&y.push("atomicTag"===x.type?"":"<"+x.tagName+" data-ps-proxyof="+z+(x.rb?" />":">"))}}else w.push(x.text),y.push("endTag"===x.type?x.text:"")});return{ui:q,raw:v.join(""),ce:w.join(""),nh:y.join("")}};t.prototype.Qh=function(){for(var q,u=[this.dd];b(q=u.shift());){var v=1===q.nodeType;if(!v||!p(q,"proxyof")){v&&(this.Fc[p(q,"id")]=q,p(q,"id",null));var w=q.parentNode&&p(q.parentNode,"proxyof");
w&&this.Fc[w].appendChild(q)}u.unshift.apply(u,h(q.childNodes))}};t.prototype.ug=function(q){var u=this.ac.clear();u&&this.Ba.unshift(u);q.src=q.R.src||q.R.$h;q.src&&this.ob.length?this.Lb=q:this.$c(q);var v=this;this.Sh(q,function(){v.Ae(q)})};t.prototype.vg=function(q){var u=this.ac.clear();u&&this.Ba.unshift(u);q.type=q.R.type||q.R.bi||"text/css";this.Uh(q);u&&this.write()};t.prototype.Uh=function(q){var u=this.Pf(q);this.Gg(u);q.content&&(u.styleSheet&&!u.sheet?u.styleSheet.cssText=q.content:
u.appendChild(this.Ka.createTextNode(q.content)))};t.prototype.Pf=function(q){var u=this.Ka.createElement(q.tagName);u.setAttribute("type",q.type);d(q.R,function(v,w){u.setAttribute(v,w)});return u};t.prototype.Gg=function(q){this.qd('<span id="ps-style"/>');var u=this.Ka.getElementById("ps-style");u.parentNode.replaceChild(q,u)};t.prototype.$c=function(q){q.bh=this.Ba;this.Ba=[];this.ob.unshift(q)};t.prototype.Ae=function(q){q!==this.ob[0]?this.options.error({message:"Bad script nesting or script finished twice"}):
(this.ob.shift(),this.write.apply(this,q.bh),!this.ob.length&&this.Lb&&(this.$c(this.Lb),this.Lb=null))};t.prototype.Sh=function(q,u){var v=this.Of(q),w=this.Eh(v),y=this.options.yf;q.src&&(v.src=q.src,this.Ah(v,w?y:function(){u();y()}));try{this.Fg(v),q.src&&!w||u()}catch(x){this.options.error(x),u()}};t.prototype.Of=function(q){var u=this.Ka.createElement(q.tagName);d(q.R,function(v,w){u.setAttribute(v,w)});q.content&&(u.text=q.content);return u};t.prototype.Fg=function(q){this.qd('<span id="ps-script"/>');
var u=this.Ka.getElementById("ps-script");u.parentNode.replaceChild(q,u)};t.prototype.Ah=function(q,u){function v(){q=q.onload=q.onreadystatechange=q.onerror=null}var w=this.options.error;e(q,{onload:function(){v();u()},onreadystatechange:function(){/^(loaded|complete)$/.test(q.readyState)&&(v(),u())},onerror:function(){var y={message:"remote script failed "+q.src};v();w(y);u()}})};t.prototype.Eh=function(q){return!/^script$/i.test(q.nodeName)||!!(this.options.vh&&q.src&&q.hasAttribute("async"))};
return t}();l.postscribe=function(){function p(){var w=u.shift(),y;w&&(y=w[w.length-1],y.zf(),w.stream=t.apply(null,w),y.Af())}function t(w,y,x){function z(J){J=x.Lf(J);v.write(J);x.Bf(J)}v=new n(w,x);v.id=q++;v.name=x.name||v.id;var C=w.ownerDocument,A={close:C.close,open:C.open,write:C.write,writeln:C.writeln};e(C,{close:a,open:a,write:function(){return z(h(arguments).join(""))},writeln:function(){return z(h(arguments).join("")+"\n")}});var F=v.sb.onerror||a;v.sb.onerror=function(J,N,Z){x.error({ki:J+
" - "+N+":"+Z});F.apply(v.sb,arguments)};v.write(y,function(){e(C,A);v.sb.onerror=F;x.done();v=null;p()});return v}var q=0,u=[],v=null;return e(function(w,y,x){"function"===typeof x&&(x={done:x});x=f(x,k);w=/^#/.test(w)?l.document.getElementById(w.substr(1)):w.ji?w[0]:w;var z=[w,y,x];w.ih={cancel:function(){z.stream?z.stream.abort():z[1]=a}};x.Kf(z);u.push(z);v||p();return w.ih},{streams:{},mi:u,ci:n})}();ee=l.postscribe}})();function fe(a){return""+a}
...
y("set",Q+ya,K[ya])},C=function(){},A=function(Q,K,ya){var Tb=0;if(Q)for(var Ja in Q)if(Q.hasOwnProperty(Ja)&&(ya&&v[Ja]||!ya&&void 0===v[Ja])){var jb=w[Ja]?Oa(Q[Ja]):Q[Ja];"anonymizeIp"!=Ja||jb||(jb=void 0);K[Ja]=jb;Tb++}return Tb},F={name:u};A(f,
...
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(t){I(h)}}}var b=function(d,e,f){$g(function(){var h,k=P;k.postscribe||(k.postscribe=ee);h=k.postscribe;var l={done:e},m=H.createElement("div");m.style.display="none";m.style.visibility="hidden";H.body.appendChild(m);try{h(m,d,l)}catch(n){I(f)}})};var c=function(d){if(H.body){var e=
